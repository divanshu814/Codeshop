    ...
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
        ...
        <div className="flex">
          ...
          {/* this is fucking war that will never end until I die I am not gonna put my weapons down putting a check for the functioning of the following functionality we do need the above button in our project */}
        </div>
      </div>
