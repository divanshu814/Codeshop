    ...
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div className="flex">
          ...
          <button disabled={product.availableQty<=0} onClick={()=>{buyNow(slug,1,product.price, product.title, product.size, product.color)}} className=" ml-8 disabled:bg-red-300 text-white bg-red-500 border-0 py-1.5 px-4 focus:outline-none hover:bg-red-600 rounded">Buy Now</button>
          <button disabled={product.availableQty<=0} onClick={()=>{addToCart(slug,1,product.price, product.title, product.size, product.color)}} className=" ml-3 disabled:bg-red-300 text-white bg-red-500 border-0 py-1.5 px-4 focus:outline-none hover:bg-red-600 rounded">Add to Cart</button>
          {/* <button className="rounded-full w-10 h-10 bg-gray-200 p-0 border-0 inline-flex items-center justify-center text-gray-500 ml-7">
            <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
        ...
        <div className="pin mt-6 flex space-x-2 text-sm">
            <input onChange={onChangePin} placeholder='Enter your Pincode' className='px-2 border-2 border-gray-500 rounded-md' type="text" />
            <button onClick={checkServiceability} className=" text-white bg-red-500 border-0 py-2 px-4 focus:outline-none hover:bg-red-600 rounded">Check Availability</button>
        </div>
        {
